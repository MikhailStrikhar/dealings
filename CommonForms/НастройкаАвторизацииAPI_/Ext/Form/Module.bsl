...
Процедура ЗаполнитьНастройки()
	...
	НастройкиАвторизации = ms_РаботаСREST.НастройкиАвторизации("СервисФинДанных");
	Если НастройкиАвторизации = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	НастройкиСервисаПереводаТекста = ms_РаботаСREST.НастройкиСервисаПереводаТекста("СервисФинДанных");
