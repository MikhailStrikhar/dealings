...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ИспользоватьСервисФинДанных = ЗначениеЗаполнено(ТекущийОбъект.СервисФинДанных);
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Владелец = ОбщегоНазначения.ИдентификаторОбъектаМетаданных("СервисФинДанных");
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если Не ЗначениеЗаполнено(НаборКонстант.СервисФинДанных) Тогда
	
		СервисФинДанных = Неопределено;
		//РаботаСRESTЛокализация.ПриОпределенииСервисФинДанных(СервисФинДанных);
		
		НаборКонстант.СервисФинДанных = "?";
	КонецЕсли;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	ЗаписанныеЗначения.Вставить("СервисФинДанных", НаборКонстант.СервисФинДанных);
	
	Оповестить("Запись_НаборКонстант", ЗаписанныеЗначения, "ИспользоватьСервисФинДанных");
...
&НаКлиенте
Процедура СервисФинДанныхПриИзменении(Элемент)
...
Процедура ЗаписатьИЗакрыть(Команда)
	Записать();
	Закрыть(НаборКонстант.СервисФинДанных);
КонецПроцедуры
...
Процедура ЗаполнитьНастройки()
	...
	СервисФинДанных = НаборКонстант.СервисФинДанных;
	...
	НастройкиАвторизации = ИнтеграцияTInvestAPI.НастройкиАвторизации("СервисФинДанных");
	Если НастройкиАвторизации = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	НастройкиСервисаПереводаТекста = ИнтеграцияTInvestAPI.НастройкиСервисаПереводаТекста("СервисФинДанных");
